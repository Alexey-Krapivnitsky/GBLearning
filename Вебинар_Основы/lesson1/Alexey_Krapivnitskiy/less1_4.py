...
num_digit = len(user_number) - 1  # номер цифры в числе, начальный - последняя цифра
max_digit = int(user_number[num_digit])  # предполагаем, что максимальная - последняя цифра
